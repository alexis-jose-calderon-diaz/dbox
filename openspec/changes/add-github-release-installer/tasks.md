...
- [ ] 3.3 Probar la deteccion de plataforma y las rutas de error HTTP de ambos scripts sin modificar ubicaciones reales del usuario, incluida una comprobacion aislada de `install.ps1` en Windows.
