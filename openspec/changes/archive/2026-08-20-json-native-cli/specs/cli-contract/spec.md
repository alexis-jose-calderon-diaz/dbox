...
#### Scenario: Return a validation or syntax error
...
**Reason**: Operational errors use a single JSON error envelope.
**Migration**: Read `error.code` and `error.message` from stderr instead of
parsing human-readable missing or deletion messages.
